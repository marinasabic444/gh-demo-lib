...
[![CI Build](https://github.com/marinasabic444/gh-demo-lib/actions/workflows/ci.yml/badge.svg)](https://github.com/marinasabic444/gh-demo-lib/actions/workflows/ci.yml)
...
repositories {
    ...
    maven {
        name = "GitHubPackages"
        url = uri("https://maven.pkg.github.com/marinasabic444/gh-demo-lib")
        credentials {
